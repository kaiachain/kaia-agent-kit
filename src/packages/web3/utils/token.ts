...
import {encodeAbiParameters, encodeFunctionData, EncodeFunctionDataParameters} from 'viem';
...
export class AbiFactory {
    ...
    private getErc20Params() {
        ...
        assert(this.params.receiver && this.params.amount, 'invalid params for transfer erc20')
    ...
    private getErc721Params() {
        ...
        assert(this.params.sender && this.params.receiver && this.params.tokenId, 'invalid params for transfer erc721')
        const args = [this.params.sender, this.params.receiver, this.params.tokenId];
    ...
    private getErc1155Params() {
        ...
        assert(this.params.sender && this.params.receiver && this.params.tokenId && this.params.amount, 'invalid params for transfer erc1155')
        const args = [this.params.sender, this.params.receiver, this.params.tokenId, this.params.amount, ""];
