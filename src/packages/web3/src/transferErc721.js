...
var transferErc721 = function (parameters, config, walletClient) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                res = {
                    ...
                    data: new token_1.AbiFactory(__assign(__assign({}, parameters), { type: "erc721" })).createParams(),
                    type: undefined,
                };
