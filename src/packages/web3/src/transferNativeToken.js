...
var transferNativeToken = function (parameters, config, walletClient) { return __awaiter(void 0, void 0, void 0, function () {
    var sender, accountType, res, sentTx, err_1;
    var _a, _b;
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                res = {
                    ...
                    value: (0, viem_1.parseEther)(parameters.amount.toString()),
                    type: undefined,
                };
                if (((_b = walletClient.provider) === null || _b === void 0 ? void 0 : _b.kaia) && (0, ethers_ext_1.isKlaytnAccountKeyType)(accountType.accType)) {
